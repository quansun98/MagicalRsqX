...
#' @param FeatureCols Vector of column numbers of all the features used for model training. By default, it will be 7:93 including 87 features covering 
...
train_MagicalRsq = function(file, header = T, outfile = NULL, nvar_use = NULL, MAF_cate = NULL, p_train = 0.7,
 trueR2Col = 5, MAFCol = NULL, FeatureCols = 7:93, seed = 123, nrounds = 3000, max.depth = 6, verbose = 1, early_stopping_rounds = 50,
 print_every_n = 20) {
